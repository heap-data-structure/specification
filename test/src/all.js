...
spec.test(
	ava ,
	[ [ "DummyHeap [300]" , partial( create , [ spec.DummyHeap ] ) ] ] ,
	{ references : true , length : true , lengths : [[300]] }
) ;

spec.test(
	ava ,
	[ [ "DummyHeapWithoutReferences [300]" , partial( create , [ spec.DummyHeapWithoutReferences ] ) ] ] ,
...
spec.test(
	ava ,
	[ [ "DummyHeapWithoutReferences (length: false) [300]" , partial( create , [ spec.DummyHeapWithoutReferences ] ) ] ] ,
